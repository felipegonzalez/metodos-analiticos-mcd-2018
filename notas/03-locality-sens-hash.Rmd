...
Y calculamos todas las posibles distancias (lo cual muchas
veces no es posible hacer):
...
coseno menor a 0.2 (menos de unos 10 grados). El número de pares que satisfacen
esta condicion son:
...
Ahora vamos a amplificar la famiia de hashes. En este caso,
...
```{r}
cubetas_agrup <- cubetas %>% group_by(cubeta) %>%
