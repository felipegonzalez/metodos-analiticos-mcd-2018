# Expermientación y algoritmos de tragamonedas (bandits)
...
el nivel de significancia (5\%). Pero en la práctica, lo que nos puede hacer perder nuestro
trabajo son los errores de tipo II (no escoger un cambio que representa una mejoría, o no identificar
un cambio que produce daños grandes).
...
Poisson, podemos estimar la varianza como $\{\lambda} / n$):
