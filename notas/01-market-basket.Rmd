...
conjuntos frecuentes de soporte mínimo 0.005 (como hay alrededor de 
10000 canastas, esto significa que canastas que aparecieron al menos 50
...
- Otros algoritmos también son explicados en [@borgelt]. A priori es el algoritmo clásico,
...
están en el mismo itemset frecuente), otras veces nos interesa entender qué artículos
...
```{r, fig.width=10, fig.height=8, warning = FALSE}
reglas_f2 <- subset(reglas_1, hyper_lift > 1.1)
...
## Tarea {-}
Considera los datos de *datos/recetas*. Cada receta es una canasta, y los
artículos son los ingredientes que usan. Puedes consultar el artículo
original [aquí](https://www.nature.com/articles/srep00196.pdf). Selecciona una
o dos regiones y aplica market basket análisis para entender cuáles son los
ingredientes importantes en ese tipo de cocina, y qué relaciones hay entre
estos ingredientes.
