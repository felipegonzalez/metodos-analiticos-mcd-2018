...
total de itemsets de tamaño $k$ es $\choose{m, k}$.
...
itemsets frecuentes.
- Equivalentemente, si algún subconjunto de un itemset no es frecuente, entonces el itemset no puede ser frecuente. Así que *a priori*, no es necesario itemsets que contienen al menos un subconjunto 
