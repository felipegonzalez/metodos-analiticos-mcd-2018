...
entre este usuario y el artículo. Definimos la variable de preferencia
...
¿Pero qué tanto valor debemos darle a esta preferencia? Por ejemplo,
puede ser que el usuario simplemente dio click en un artículo y no hizo nada más,

La idea es que un valor bajo de $r_{ij}$ no necesariamente indica alguna
preferencia, pero conforme crece este valor, tenemos más confianza de
que el usuario prefiere el artículo. Definimos entonces
$$c_{ij} = 1+ \alpha r_{ui},$$
donde $\alpha$ es un parámetro que hay que afinar (por ejemplo $\alpha = 40$)
