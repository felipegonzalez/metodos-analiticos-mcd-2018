...
$$
L =  \sum_{(i,j) obs}\left ( (x_{ij} - a_i - b_j - \sum_{l=1}^k u_{i,l}v_{j,l})^2 +
\lambda \left (  ||u_i||^2 +  ||v_j||^2 +  a_i^2 + b_j^2 \right )\right)
$$
...
Puedes ver [este video](https://www.youtube.com/watch?v=GGWBMg0i9d4&index=56&list=PLLssT5z_DsK9JDLcT8T62VtzwyW9LNepV) de nuestro libro de texto. El planteamiento
es ligeramente diferente (el parámetro $lambda$ se trata de manera diferente), pero
las ideas básicas son las mismas.
