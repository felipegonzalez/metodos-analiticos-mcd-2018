...
entonces el número de clientes muestreados crecerá de manera correspondiente (veremos
más adelante qué hacer si queremos evitar esto).
...
Vamos a interpretar el bloom filter como una clase R6:
