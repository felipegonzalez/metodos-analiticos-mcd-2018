...
$$sim(a,b) \approx \frac{|\pi_j : h\pi_j(a) = h\pi_j(b)|}{n}, $$
es decir, la similitud de jaccard es aproximadamente el número
de 
```
...
de firmas que calculamos arriba. Tendríamos, por ejemplo para los primeros
dos documentos
...
- El renglón $k$ puede ser de tipo $(1,0), (0,1), (1,1)$. El número de estos
renglones es el tamaño de $A\cup B$, pues este número cuenta cuántas tejas en común
tienen estos conjuntos.
- El número de tejas $(1,1)$ es el tamaño de $A\cap B$, el número de tejas en común de los dos documentos.
