...
El problema con el procedimiento de arriba es el costo de calcular las permutaciones, permutar los renglones,
...
**Observación**: Otra forma de ver el paso 3 es el siguiente: simplemente
calculamos los hashes para las tejas que están en el documento, y luego
calculamos el mínimo de estos hashes.
...
¿Cuáles son las verdaderas distancias de jaccard?
