...
donde las $y_i$ son las salidas de la capa anterior. La dificultad está en el segundo término, que es sobre todo el vocabulario en incluye todos los parámetros del modelo.
...
$$E = -\log\sigma(y_w) + \sum_k \log\sigma(y_k).$$
